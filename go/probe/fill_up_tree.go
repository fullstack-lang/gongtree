	...
	for _, gongStruct := range sliceOfGongStructsSorted {
		...
		case "Button":
			...
			for _button := range set {
				nodeInstance := (&tree.Node{Name: _button.GetName()}).Stage(playground.treeStage)
				nodeInstance.IsNodeClickable = true
				nodeInstance.Impl = NewInstanceNodeCallback(_button, "Button", playground)
		...
		case "Tree":
			...
			for _tree := range set {
				nodeInstance := (&tree.Node{Name: _tree.GetName()}).Stage(playground.treeStage)
				nodeInstance.IsNodeClickable = true
				nodeInstance.Impl = NewInstanceNodeCallback(_tree, "Tree", playground)
