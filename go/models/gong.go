...
func GetFields[Type Gongstruct]() (res []string) {
	...
	case Node:
		res = []string{"Name", "IsHighlighted", "IsExpanded", "HasCheckboxButton", "IsChecked", "IsCheckboxDisabled", "IsInEditMode", "IsNodeClickable", "Children", "Buttons"}
	case Tree:
...
func GetFieldStringValueFromPointer[Type PointerToGongstruct](instance Type, fieldName string) (res string) {
	...
	case *Node:
		...
		case "Name":
			res = inferedInstance.Name
		case "IsHighlighted":
			res = fmt.Sprintf("%t", inferedInstance.IsHighlighted)
		case "IsExpanded":
