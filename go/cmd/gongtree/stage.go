...
func stageInjection(stage *models.StageStruct) {
	...
	__Node__000001_test := (&models.Node{Name: `test`}).Stage(stage)
	__Node__000002_test2 := (&models.Node{Name: `test2`}).Stage(stage)
	...
	// Node values setup
	__Node__000001_test.Name = `test`
	__Node__000001_test.IsExpanded = false
	__Node__000001_test.HasCheckboxButton = false
	__Node__000001_test.IsChecked = false
	__Node__000001_test.IsCheckboxDisabled = false
	__Node__000001_test.IsInEditMode = false

	// Node values setup
	__Node__000002_test2.Name = `test2`
	__Node__000002_test2.IsExpanded = false
	__Node__000002_test2.HasCheckboxButton = false
	__Node__000002_test2.IsChecked = false
	__Node__000002_test2.IsCheckboxDisabled = false
	__Node__000002_test2.IsInEditMode = false
