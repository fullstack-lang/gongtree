...
func (nodeImplGongstruct *NodeImplGongstruct) OnAfterUpdate(
	...
	if nodeImplGongstruct.gongStruct.GetName() == "Button" {
		fillUpTable[models.Button](nodeImplGongstruct.stageOfInterest, tableStage, nodeImplGongstruct.formStage, nodeImplGongstruct.r, nodeImplGongstruct.backRepoOfInterest)
	}
	if nodeImplGongstruct.gongStruct.GetName() == "Node" {
		fillUpTable[models.Node](nodeImplGongstruct.stageOfInterest, tableStage, nodeImplGongstruct.formStage, nodeImplGongstruct.r, nodeImplGongstruct.backRepoOfInterest)
	}
	if nodeImplGongstruct.gongStruct.GetName() == "Tree" {
		fillUpTable[models.Tree](nodeImplGongstruct.stageOfInterest, tableStage, nodeImplGongstruct.formStage, nodeImplGongstruct.r, nodeImplGongstruct.backRepoOfInterest)
	}
