...
import (
	...
	"github.com/fullstack-lang/gongtree"
...
func ServeStaticFiles(logGINFlag bool) (r *gin.Engine) {
	...
	r.Use(static.Serve("/", EmbedFolder(gongtree.NgDistNg, "ng-github.com-fullstack-lang-gongtree/dist/ng-github.com-fullstack-lang-gongtree/browser")))
